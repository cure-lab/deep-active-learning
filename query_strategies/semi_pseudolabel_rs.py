...
class pseudolabel_rs(Strategy):
    ...
    def __init__(self, X, Y, X_te, Y_te, idxs_lb, net, handler, args):
        super(pseudolabel_rs, self).__init__(X, Y, X_te, Y_te, idxs_lb, net, handler, args)
    ...
    def train(self, alpha=0.1, n_epoch=10):
        ...
        if idxs_train.shape[0] != 0:
            ...
            train_data_labeled = self.handler(self.X[idxs_train] if not self.pretrained else self.X_p[idxs_train],
